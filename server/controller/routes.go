...
func (c *Controller) RegisterRoutes(app *echo.Echo) {
	...
	billed.POST("/bank_accounts/:bankAccountId/accrual/:accrualExpenseId/usage_logs", c.postAccrualUsageLog)
	billed.DELETE("/bank_accounts/:bankAccountId/usage_logs/:accrualUsageLogId", c.deleteAccrualUsageLog)
